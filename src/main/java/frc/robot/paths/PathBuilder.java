...
public class PathBuilder {
    ...
    private static final double kBigNumber = 1E9;
    ...
    static class Line {
        ...
        private void addToPath(Path p, double endSpeed) {
            ...
            if(pathLength > kEpsilon) {
                if(b.marker != null) {
                    p.addSegment(new PathSegment(start.x(), start.y(), end.x(),
                        end.y(), b.speed, p.getLastMotionState(), endSpeed, b.marker));
                } else {
    ...
    static class Arc {
        ...
        private void addToPath(Path p) {
            a.addToPath(p, speed);
            if(radius > kEpsilon && radius < kBigNumber) {
