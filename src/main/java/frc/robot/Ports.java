...
public class Ports {
	...
	public static final int INTAKE_INNER_MOTOR_ID = 0;
	public static final int INTAKE_OUTER_MOTOR_ID = 0;

	public static final int SHOOTER_HOOD_SOLENOID_PORT = 0;
	...
	public static final int HOPPER_INDEX_ID = 0;
